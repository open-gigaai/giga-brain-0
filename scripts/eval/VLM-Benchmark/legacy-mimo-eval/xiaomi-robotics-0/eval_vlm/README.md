...
Run commands from `scripts/eval/VLM-Benchmark`. From the main repository root:
...
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/main.py \
  ...
  --output legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/results/realworldqa_predictions.jsonl
```
...
`legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/results/realworldqa_predictions.metrics.json`.
...
```bash
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/erqa.py \
  --model-path XiaomiRobotics/Xiaomi-Robotics-0-Pretrain \
  --data-root datasets/public_datasets/VLM/vqa/benchmarks/ERQA \
  --batch-size 1 \
  --attn-implementation flash_attention_2 \
  --output legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/results/erqa_predictions.jsonl
```

If `flash-attn` is not available:

```bash
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/erqa.py --attn-implementation sdpa
```
...
```bash
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/eobench.py \
  --model-path XiaomiRobotics/Xiaomi-Robotics-0-Pretrain \
  --data-root datasets/public_datasets/VLM/vqa/benchmarks/EO-Bench \
  --batch-size 1 \
  --attn-implementation flash_attention_2 \
  --output legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/results/eobench_predictions.jsonl
```

If `flash-attn` is not available:

```bash
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/eobench.py --attn-implementation sdpa
```
...
```bash
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/cvbench.py
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/embspatial.py
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/sat.py
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/metavqa.py
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/crpe.py
```

Spatial point / mask benchmarks:

```bash
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/where2place.py
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/part_affordance.py
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/roboafford.py
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/refspatial.py
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/robospatial_home.py
```

BBox / point-in-box benchmarks:

```bash
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/roborefit.py
python legacy-mimo-eval/xiaomi-robotics-0/eval_vlm/vabench_point_bbox.py
```
